    ...
    <div className="min-h-screen bg-[#0A0A0A] text-[#F5F5F0] font-sans">
      ...
      <main className="pt-28 pb-24">
        <div className="mx-auto max-w-3xl px-6">
          <div className="mb-12">
            <div className="text-xs font-extrabold tracking-[0.2em] uppercase text-[#14B8A6] mb-4">Compliance</div>
            <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-4">HIPAA Compliance</h1>
            <p className="text-[#A3A3A3] text-lg">Our commitment to protecting patient health information</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            {[
              ...
              <div key={badge.label} className="rounded-xl border border-[#14B8A6]/20 bg-[#14B8A6]/[0.04] p-4 text-center">
                <IconShieldCheck className="w-6 h-6 text-[#14B8A6] mx-auto mb-2" />
                <div className="text-sm font-bold text-[#F5F5F0]">{badge.label}</div>
                <div className="text-xs text-[#A3A3A3] mt-1">{badge.sub}</div>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-8">
            ...
            <Section title="Business Associate Agreement (BAA)">
              ...
              <p>
                ...
                <a href="mailto:thomas@lvlai.app" className="text-[#14B8A6] hover:text-[#5EEAD4] transition-colors">thomas@lvlai.app</a>.
              </p>
            </Section>
